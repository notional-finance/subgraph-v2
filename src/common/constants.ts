...
export const PRIME_CASH_VAULT_MATURITY = BigInt.fromI32(2).pow(40).minus(BigInt.fromI32(1));
...
export const PrimeCashPremiumInterestRate = "PrimeCashPremiumInterestRate";
export const PrimeDebtPremiumInterestRate = "PrimeDebtPremiumInterestRate";
export const PrimeCashExternalLendingInterestRate = "PrimeCashExternalLendingInterestRate";
...
export const VaultShareInterestAccrued = "VaultShareInterestAccrued";
...
export const nTokenInterestAccrued = "nTokenBlendedInterestAccrued";
